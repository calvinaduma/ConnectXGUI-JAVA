 ...
 */
public class SetupController implements IGameBoard {

    private SetupView view;
    private int max_size = MAX_SIZE; //
    private int min_size = MIN_SIZE; //
    private int min_to_win = MIN_TO_WIN; //
    private final int BOARD_CUTOFF = BOARD_CUT_OFF; //
